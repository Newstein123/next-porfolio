...
export async function PUT(req, {params})
{
    ...
    try {
        ...
        const gs = await GeneralSetting.findByIdAndUpdate({_id : id}, {
        ...
        return new Response(apiResponse(true, 'General Setting Updated Successfully', gs))
    } catch (error) {
        return new Response(apiResponse(false, 'Something Wrong! Server Error', null, error.message))
    }
}
...
export async function DELETE(req, {params})
{
    try {
        ...
        return new Response(apiResponse(true, 'General Setting Deleted Successfully'))
    } catch (error) {
        return new Response(apiResponse(false, 'Something Wrong! Server Error', null, error.message))
    }
}