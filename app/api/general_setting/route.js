...
export async function GET()
{
    try {
        ...
        return new Response(apiResponse(false, 'Server Error! Something Wrong', null, error.message))
    }
}
...
export async function POST(req)
{
    try {
        ...
        await gs.save();
        return new Response(apiResponse(true, 'General Setting Created Successfully', gs))
    } catch (error) {
        return new Response(apiResponse(false, 'Server Error! Something Wrong', null, error.message))
    }
}